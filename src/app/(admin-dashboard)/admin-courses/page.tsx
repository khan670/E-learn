...
const Courses = () => {
  return (
    <section className="py-5 px-10">
      <h1 className="text-xl font-semibold text-slate-700">All Users</h1>
      <div className=" mt-5 text-[#1A2D62] grid grid-cols-4 gap-5">
        {["Total Courses", "Paid Courses", "Free Courses"].map((value) => (
          <>
      ...
      <div className="bg-white shadow p-2 flex flex-col mt-5  rounded-md">
        <div className="flex items-center justify-between">
          <Button text="Add Course" className="!text-xs !p-2" />
        ...
        <table className="w-full mt-5 ">
          <thead className="">
            <tr className="text-base font-medium border-b-2 border-b-gray-700">
              <th className="py-3"> Course ID</th>
              <th>Course Title</th>
              <th>Instructor Name</th>
              <th>Enrolled Students Count</th>
              <th>Created Date</th>
              <th>Status </th>
              <th>Actions</th>
            </tr>
