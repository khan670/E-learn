...
const AboutSection = () => {
  return (
    <section className="grid grid-cols-2 gap-10 px-21 py-10 mt-10">
      <div>
        <Image
          src={"/about_1.png"}
          alt="about-1"
          ...
          <div
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-gray-400 text-base leading-[1.3]">
                ...
                Cupiditate dignissimos sapiente sequi, minus magnam rem numquam
              </p>
            </div>
          </div>
        ))}
        <ActionButton text="Discover Me" className="mt-auto" />
      </div>
    </section>
  );
};
